...
namespace eosio::chain {
   ...
   void deep_mind_handler::on_newaccount_resource_limits(const resource_limits::resource_object& limits)
   {
      fc_dlog(_logger, "RLIMIT_OP ACCOUNT_LIMITS INS ${data}",
         ("data", limits)
      );
   }
   void deep_mind_handler::on_update_account_usage(const resource_limits::resource_object& limits)
   {
      fc_dlog(_logger, "RLIMIT_OP ACCOUNT_LIMITS UPD ${data}",
         ("data", limits)
      );
   }
   void deep_mind_handler::on_set_account_limits(const resource_limits::resource_object& limits, const resource_limits::resource_pending_object& pending)
   {
      fc_dlog(_logger, "RLIMIT_OP ACCOUNT_LIMITS UPD ${data}",
         ("data", limits)
      );
