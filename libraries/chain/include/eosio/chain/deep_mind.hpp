...
public:
   ...
   void on_update_account_usage(const resource_limits::resource_object& limits);
   void on_set_account_limits(const resource_limits::resource_object& limits, const resource_limits::resource_pending_object& pending);
